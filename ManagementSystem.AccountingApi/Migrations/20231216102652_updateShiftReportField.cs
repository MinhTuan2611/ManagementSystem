...
{
    public partial class updateShiftReportField : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<long>(
                name: "TotalPointAmount",
                table: "ShiftReports",
                type: "bigint",
                nullable: false,
                defaultValue: 0L);

            migrationBuilder.Sql(@"USE [AccountingsProdDb]
GO
/****** Object:  StoredProcedure [dbo].[sp_generate_shift_handover]    Script Date: 12/16/2023 5:16:32 PM ******/
SET ANSI_NULLS ON
GO
...
GO
                ...
                ALTER     PROCEDURE [dbo].[sp_generate_shift_handover]
    				(
    					@ShiftEndId INT
    					,@storateId INT
    					,@brandId INT
    					...
    					BEGIN TRY
    						...
    						BEGIN
    							...
    							SELECT @shiftId,         -- ShiftId - int
    								...
    								COALESCE(CASH, 0) + COALESCE(@shiftInReceiveMoney, 0) - @totalPayment,            -- RemindMoneyForNextShift - int
